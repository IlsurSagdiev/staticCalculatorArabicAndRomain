...
// Если что то не устроит могу сделать не статик и уже через экземпляр класса работать.
// Так же поля и методы являются частично package и частично public. Так что инкапсуляцией и сокрытием данных тут не пахнет. Хотя в ТЗ было упоминание о принципах ООП.
// Во второй версии калькулятора, я старался их соблюдать.
// Вторую версию можно найти тут:  https://github.com/VenatorNagibator/ArabicAndRomainCalculaterWithInstance
